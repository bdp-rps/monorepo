...
export default () => {
  return (
    <Template>
      <Head>
        <title>Pfadfinder Stamm Sturmvogel Birkenfeld Impressum</title>
        <meta
          name="description"
          content="Impressum für die Pfadfinder Stamm Sturmvogel Birkenfeld BdP"
        />
      </Head>
      <Layout paddingTop={10} paddingBottom={10}>
        <Box space={8} paddingBottom={10}>
          ...
          <Text>
            ...
            <br />
            <br />
            <b>Stamm Sturmvogel Birkenfeld</b>
            <br />
            <br />
