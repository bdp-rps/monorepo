    ...
    return (
        <Template>
            <Layout paddingTop={10} paddingBottom={15}>
                <Text intent="subtitle">Wölflinge</Text>
                <Spacer size={4} />
                <Box space={6}>
                    <Box space={1}>
                        <Text>  Wölflinge sind die Jungen und Mädchen im Alter von sieben bis elf Jahren. Zusammen bilden wir eine Gruppe von etwa 15 bis 30 Kindern, die wir die „Meute” nennen. Wir treffen uns einmal in der Woche zur Meutenstunde und unternehmen gemeinsam lustige und spannende Dinge.
            ...
            Ansprechpartner für die Wölflingsmeute: {representatives.map((representative) => representative.name + " ")}
                            <br />
