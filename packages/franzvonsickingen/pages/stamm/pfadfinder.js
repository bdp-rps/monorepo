                                ...
                                return (
                                    <Box maxWidth={500}>
                                        <Tile title={sippe.name}>
                                            ...
                                            <Text>Sippenführer*innen: {sippe.leader.map((leader) => leader + ' ')}</Text>
                                            <Text>Gruppenstunde: {sippe.meeting}</Text>
                                            <Text>Jahrgang: {sippe.year}</Text>
                                            <Text>Besondere Aktionen: {sippe.campaigns.map((campaign) => campaign + ' ')}</Text>
                                        </Tile>
                                    </Box>
                                )
                            })}
