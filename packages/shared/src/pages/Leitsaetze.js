  ...
  <React.Fragment>
    ...
    <Box paddingTop={2} direction={'column'} space={4}>
      <Tile
        ...
        eigenverantwortlichen, kritischen und engagierten Persönlichkeiten zu
        unterstützen.
        <br />
        Unsere Mitglieder sollen in der Lage sein, Verantwortung für sich selbst
        und für andere zu übernehmen. Die Fähigkeiten und Werte,
        <br />
        die sie im Stamm und Landesverband erwerben, sollen sie auch außerhalb
        unserer Gemeinschaft positiv in die Gesellschaft einbringen.
        <br />
        Um dieses Ziel zu erreichen, müssen junge Leute in unserem Landesverband
        ein stimmiges Umfeld finden, in dem ihre Persönlichkeit wachsen kann.
      </Tile>
      <Tile
        title={
          <>
            2. als eine echte Gemeinschaft von <br /> Freundinnen und Freunden
            miteinander leben
          </>
        }
        ...
        highlight
        imageHeight={400}>
        Wir sind mehr als ein geographischer Zusammenschluss von Stämmen, weil
        wir uns als Weggefährten verstehen und füreinander einstehen.
        <br />
        Wir begegnen uns als Freundinnen und Freunde, denn Freundschaft ist das
        Band, das unsere Gemeinschaft zusammenhält.
        <br />
      ...
      <Tile
        ...
        highlight
        imageHeight={400}>
        Unser Landesverband wird von jungen Menschen gebildet, die Lust haben,
        sich ihre eigene Gemeinschaft zu schaffen.
        <br />
        Diese gestalten und bereichern sie durch ihren Einsatz, ihre
        Persönlichkeit und Einzigartigkeit.
        <br />
        Alle Mitglieder sollen aktiv und ihren ihren Fähigkeiten entsprechend
        zum Gelingen unserer Gemeinschaft beitragen.
        <br />
        Die verbindliche Teilnahme an den Gruppentreffen, Lagern und Fahrten ist
        die erste Voraussetzung für alle, die zu uns gehören wollen.
      </Tile>
      <Tile
        ...
        <br />
        Wir stehen uns gegenseitig mit Rat und Tat zur Seite und sind offen für
        Hilfe, die uns angeboten wird.
        <br />
      ...
      <Tile
        ...
        <br />
        Wir wollen in unserer Verschiedenheit aber nicht das Trennende betonen,
        sondern Brücken von Stamm zu Stamm schlagen.
        <br />
      ...
      <Tile
        ...
        <br />
        Diese finden sich in unseren Pfadfinderregeln wieder, die den ideellen
        Rahmen für unsere Arbeit bilden.
        <br />
        ...
        <br />
        Die Älteren haben die Aufgabe, die Traditionen unserer Gemeinschaft an
      ...
      <Tile
        ...
        Gemeinschaft sind.
        <br />
        Das gilt zuerst für unseren Umgang untereinander, der von gegenseitiger
        Rücksichtnahme und Wertschätzung geprägt sein soll.
        <br />
        Das gilt aber auch für unsere Kluft, die Ausdruck unserer Verbundenheit
        untereinander und mit allen Pfadfinderinnen und Pfadfindern auf der Welt
        ist.
        <br />
        Daher tragen wir sie bei allen Pfadfinderaktionen.
        <br />
        Alle Mitglieder sollen die Bedeutung der Kluft kennen und wissen, warum
        wir sie schlicht und ordentlich tragen.
        <br />
        Wir pflegen einen einfachen und naturverbunden Fahrten- und Lagerstil.
        <br />
        Wir bauen unsere Zelte ordentlich auf und legen Wert auf eine stilvolle
        Atmosphäre in unseren Kohten und Jurten.
        <br />
        Wir verzichten bewusst auf technische Gegenstände auf Fahrt und im
        Lager.
        <br />
        Auf unseren Treffen gehen wir verantwortungsvoll mit Nikotin & Alkohol
        um.
      </Tile>
      <Tile
        ...
        highlight
        imageHeight={400}>
        Um unserem pädagogischen Anspruch gerecht zu werden, muss das Programm
        für die Jungen und Mädchen in den anspruchsvoll,
        <br />
        ...
        <br />
        sich selbst auszuprobieren, sich immer wieder neuen Herausforderungen zu
        stellen und in zunehmendem Maße Verantwortung zu übernehmen.
      </Tile>
      <Tile
        ...
        <br />
        Es ist unser Anspruch, uns mit den Menschen und der Kultur der Länder
        auseinander zu setzen,
        <br />
        in die wir fahren. Wir vermitteln in unseren Gruppen die nötigen
        Kenntnisse,
        <br />
        die uns auf Fahrt das Leben erleichtern. Unterwegs verhalten wir uns so,
        dass wir die Gastfreundschaft,
        <br />
        ...
        <br />
        ist es uns wichtig, den Fähigkeiten der Gruppe angemessene Distanzen zu
        erwandern.
      </Tile>
      <Tile
        ...
        <br />
        Wir setzen uns auch mit den Texten und dem Hintergrund unserer Lieder
      ...
      <Tile
        title={
          <>
            {' '}
            11. unsere Führungskräfte im Stamm <br /> und auf Kursen kompetent
            für ihre Aufgaben ausbilden{' '}
          </>
        }
        ...
        Die Grundlage dafür wird in den Stämmen gelegt.
        <br />
        Alle unsere Mitglieder sollen hier die auf Fahrt und im Lager benötigten
        Pfadfindertechniken lernen.
        <br />
        Damit junge Menschen die Möglichkeit haben, selbst Verantwortung zu
        übernehmen,
        <br />
        werden unsere Gruppen von Jugendlichen geführt. Erwachsene können in der
        Meuten-,
        <br />
        ...
        <br />
        ihrer Aufgabe gerecht zu werden und sie so vor Überforderung schützen.
      ...
      <Tile
        ...
        highlight
        imageHeight={400}>
        Wir setzen uns damit auseinander, wie wir in der Öffentlichkeit wirken
        und bemühen uns um ein authentisches, positives Außenbild.
        <br />
      ...
      <Tile
        ...
        <br />
        ernsthaft und ambitioniert am bestmöglichen Programm für unsere Gruppen
        und Stämme.
        <br />
